    ...
    <div className="container mx-auto p-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter a YouTube playlist URL to analyze its videos</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <ul className="space-y-4">
                {videoData.map((video, index) => (
                  <li key={index} className="flex items-start space-x-4">
                    ...
                    <img src={video.thumbnail || "/placeholder.svg"} alt={video.title} className="w-24 h-auto" />
                    <div>
